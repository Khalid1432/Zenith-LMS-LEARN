...
export const courseCategories = [
  ...
  { id: "frontend-development", label: "Frontend Development", icon: Layout },
  { id: "data-science", label: "Data Science", icon: BarChart },
  { id: "machine-learning", label: "Machine Learning", icon: Brain },
  { id: "artificial-intelligence", label: "Artificial Intelligence", icon: Bot },
  ...
  { id: "software-engineering", label: "Software Engineering", icon: Wrench },
];
